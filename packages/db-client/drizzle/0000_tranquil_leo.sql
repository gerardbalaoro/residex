...
--> statement-breakpoint
ALTER TABLE "cases" ADD CONSTRAINT "cases_institutionId_institutions_id_fk" FOREIGN KEY ("institutionId") REFERENCES "public"."institutions"("id") ON DELETE set null ON UPDATE no action;